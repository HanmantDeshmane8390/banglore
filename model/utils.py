...
if __name__ == "__main__":
    ...
    Price_predict = HousePrice(size,bath,balcony,total_squre_fit,area_type,location)
    charges = Price_predict.get_predicted_price()
    #print()
    print(f"The Predicted House Price in Banglore city is {charges} Rs/- Only (Lakh)")